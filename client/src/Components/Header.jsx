      ...
      <div className="flex items-center gap-4">
        {isAuth ? (
          <Button
            ...
            className="bg-red-600 hover:bg-red-700 border-none font-semibold rounded-full px-6"
          >
            Logout
          </Button>
        ) : (
          <>
            <Link to="/signin">
              <Button type="text" className="text-gray-300 hover:text-white font-semibold text-lg">
                Sign in
              </Button>
            </Link>
            <Link to="/signup">
              <Button className="bg-white text-black hover:bg-gray-200 border-none rounded-full px-8 font-bold text-base h-10">
                Sign up
              </Button>
            </Link>
          </>
